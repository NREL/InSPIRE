...
plot_inter_panel_gap_trends__emmeans <- function(df, emm, pd, y_axis_title){
...
# Each year is own facet
plot_inter_panel_gap_trends__t <- function(df, pd, y_axis_title){
...
get_treatment_year_error_bar_data <- function(df, t_dist) {
    if (t_dist) {
